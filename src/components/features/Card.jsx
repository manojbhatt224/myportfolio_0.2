...
const Card = ({item:{title,des,icon}}) => {
  return (
    <div className="w-full px-12 h-100 py-5 rounded-lg shadow-shadowOne flex items-center hover:bg-gradient-to-r hover:from-blue-800 hover:to-blue-900 group bg-gradient-to-b from-black to-[#1e2024] transition-colors duration-100 group">
